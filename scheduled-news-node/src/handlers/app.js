...
// The url will change after deployment 
// Steps: Api gateway --> Deploy API 
const getNews = async () => {
  const news = await axios.get(
    "https://26f36kayjd.execute-api.us-east-1.amazonaws.com/Prod/news"
  );
  return news.data;
};
